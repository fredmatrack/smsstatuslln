...
<?php
	...
	$platform = 'https://UWPLATFORM.smartschool.be/Webservices/V3?wsdl';
	$paswoord = 'paswoord_webservice_smartschool';
            	...
            	<?php
	                ...
	                if(isset($_GET['actie']) &&  $_GET['actie'] == 'leerling' && isset($_GET['internnummer']) && isset($_GET['lstKlas']) && in_array($_GET['lstKlas'], $arr_klassen)){
	                	...
	                	// SOAP request naar Smartschool en alle leerlingen opvragen
	                		$wsresult = $client->getUserDetailsByNumber($paswoord, $internnummer);
	                	
	                		if(is_int($wsresult)){
	                			echo "<div>Leerling niet gevonden in Smartschool!</div>";
	                		}
	                		
	                		else {
	                			// wsresult verwerken json
	                			$lln = json_decode($wsresult);
